...
enum class Color(val hueRange: Pair<Int, Int>, val lowerBounds:List<Pair<Int, Int>>) {
    ...
    RED(
        Pair(-26, 18),
        listOf(Pair(20, 100), Pair(30, 92), Pair(40, 89), Pair(50, 85), Pair(60, 78), Pair(70, 70), Pair(80, 60), Pair(90, 55), Pair(100, 50))
    ),
    ORANGE(
        Pair(18, 46),
    ...
    YELLOW(
        Pair(46, 62),
        listOf(Pair(25, 100), Pair(40, 94), Pair(50, 89), Pair(60, 86), Pair(70, 84), Pair(80, 82), Pair(90, 80), Pair(100, 75))
    ),
    GREEN(
        Pair(62, 178),
        listOf(Pair(30, 100), Pair(40, 90), Pair(50, 85), Pair(60, 81), Pair(70, 74), Pair(80, 64), Pair(90, 50), Pair(100, 40))
    ),
    BLUE(
        Pair(178, 257),
        listOf(Pair(20, 100), Pair(30, 86), Pair(40, 80), Pair(50, 74), Pair(60, 60), Pair(70, 52), Pair(80, 44), Pair(90, 39), Pair(100, 35))
    ),
    PURPLE(
        Pair(257, 282),
        listOf(Pair(20, 100), Pair(30, 87), Pair(40, 79), Pair(50, 70), Pair(60, 65), Pair(70, 59), Pair(80, 52), Pair(90, 45), Pair(100, 42))
    ),
    PINK(
        Pair(282, 334),
